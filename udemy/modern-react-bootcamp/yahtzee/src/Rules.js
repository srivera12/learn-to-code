...
const fullHouse = new FullHouse({ score: 25, description: '25 points for 3 and 2 of a kind' });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, description: '30 points if 4 are in order' });
const largeStraight = new LargeStraight({ score: 40, description: '40 points if all 5 are in order' });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, description: '50 points if all 5 are the same' });
